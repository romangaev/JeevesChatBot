...
training_data.append({"class":"english", "sentence":"learning"})
training_data.append({"class":"english", "sentence":"study"})
training_data.append({"class":"english", "sentence":"English"})
training_data.append({"class":"english", "sentence":"training"})
...
classify("Hey are you alright?")
classify("goodbye baby!")
classify("teach me please!")
classify("go")